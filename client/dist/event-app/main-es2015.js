...
/* harmony import */ var _pipes_event_price_pipe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../pipes/event-price.pipe */ "./src/app/pipes/event-price.pipe.ts");
...
function EventCardComponent_span_19_Template(rf, ctx) { if (rf & 1) {
...
EventCardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EventCardComponent, selectors: [["app-event-card"]], inputs: { event: "event" }, decls: 20, vars: 12, consts: [[3, "routerLink"], [1, "card"], [1, "price"], [1, "card-image"], [1, "image", "is-16by9"], ["alt", "Event image", 3, "src"], [1, "card-content"], [1, "media"], [1, "media-content"], [1, "title", "is-5"], [1, "content"], [1, "tags"], ["class", "tag is-normal", 4, "ngFor", "ngForOf"], [1, "tag", "is-normal"]], template: function EventCardComponent_Template(rf, ctx) { if (rf & 1) {
